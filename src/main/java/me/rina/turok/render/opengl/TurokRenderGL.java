...
public class TurokRenderGL {
	...
	public static void drawOutlineRect(float x, float y, float width, float height) {
		...
		prepare(GL11.GL_LINE_LOOP);
		{
			...
			addVertex(x + width, y + height + offset);
			addVertex(x + width, y);
		}
	...
	public static void drawRoundedRect(float x, float y, float width, float height, float radius) {
		...
		drawArc((x + width - radius), (y + height - radius), radius, 0, 90, 32);
		drawArc((x + radius), (y + height - radius), radius, 90, 180, 32);
		drawArc(x + radius, y + radius, radius, 180, 270, 32);
		drawArc((x + width - radius), (y + radius), radius, 270, 360, 32);
