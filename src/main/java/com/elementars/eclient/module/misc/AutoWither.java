...
public class AutoWither extends Module {
    ...
    private final Value<String> useMode = register(new Value<>("UseMode", this, "Spam", EnumUtil.enumConverter(UseMode.class)));
    private final Value<Float> placeRange = register(new Value<>("PlaceRange", this, 3.5f, 2.0f, 10f));
    private final Value<Integer> delay = register(new Value<>("Delay", this, 20, 12, 100));
    private final Value<Boolean> rotate = register(new Value<>("Rotate", this, true));
    private final Value<Boolean> debug = register(new Value<>("Debug", this, false));
    ...
    public AutoWither() {
        super("AutoWither", "Automatically places withers", Keyboard.KEY_NONE, Category.MISC, true);
    }
    ...
    private boolean testWitherStructure() {
        ...
        for (BlockPos pos : BodyParts.ArmsX) {
            if (!this.placingIsBlocked(this.placeTarget.add(pos)) && !this.placingIsBlocked(this.placeTarget.add(pos.down()))) continue;
