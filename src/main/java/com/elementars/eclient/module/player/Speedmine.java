...
public class Speedmine extends Module {
    ...
    public Speedmine() {
        super("Speedmine", "Speeds up mining.", Keyboard.KEY_NONE, Category.PLAYER, true);
        this.tweaks = this.register(new Value<>("Tweaks", this, true));
        this.mode = this.register(new Value<>("Mode", this, Mode.PACKET, Mode.values()))
                .visibleWhen(mode1 -> tweaks.getValue());
        this.reset = this.register(new Value<>("Reset", this, true));
        this.damage = this.register(new Value<>("Damage", this, 0.7f, 0.0f, 1.0f))
                .visibleWhen(aFloat -> this.mode.getValue() == Mode.DAMAGE && this.tweaks.getValue());
        ...
        this.pickaxe = this.register(new Value<>("Pickaxe", this, true))
                .visibleWhen(aBoolean -> this.noTrace.getValue());
        ...
        this.box = this.register(new Value<>("Box", this, false))
                .visibleWhen(aBoolean -> this.render.getValue());
        this.outline = this.register(new Value<>("Outline", this, true))
                .visibleWhen(aBoolean -> this.render.getValue());
        this.boxAlpha = this.register(new Value<>("BoxAlpha", this, 85, 0, 255))
                .visibleWhen(integer -> this.box.getValue() && this.render.getValue());
        this.lineWidth = this.register(new Value<>("LineWidth", this, 1.0f, 0.1f, 5.0f))
                .visibleWhen(aFloat -> this.outline.getValue() && this.render.getValue());
