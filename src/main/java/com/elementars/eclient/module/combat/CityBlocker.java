...
public class CityBlocker extends Module {
    ...
    private final Value<Boolean> turnOffCauras = register(new Value<>("Toggle Other Cauras", this, true));
    ...
    public CityBlocker() {
        super("CityBlocker", "Prevents city traps", Keyboard.KEY_NONE, Category.COMBAT, true);
