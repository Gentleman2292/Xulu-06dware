...
public class AnnouncerUtil {
    ...
    public static String getBlockBreak(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just broke a " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05e8\u05d1\u05e9 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getMove(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just moved " + s + " feet thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u05d8\u05d9\u05e4 \u003c\u003e \u05d9\u05ea\u05d6\u05d6 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getCraft(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just crafted " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05e8\u05e6\u05d9 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getPickedUp(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just picked up a " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05de\u05e8\u05d4 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getSmelted(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just smelted " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05db\u05ea\u05d4 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }
    ...
    public static String getPlaced(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just placed a " + s + " block thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05d7\u05e0\u05d4 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getDropped(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just dropped a " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05dc\u05e4\u05d4 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }
    ...
    public static String getAte(String s) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
            return "I just ate a " + s + " thanks to Xulu!";
        } else if (Announcer.mode.getValue().equalsIgnoreCase("Hebrew")) {
            String x = "!Xulu " + "\u05ea\u05d5\u05db\u05d6\u05d1 \u003c\u003e \u05d9\u05ea\u05dc\u05db\u05d0 \u05e2\u05d2\u05e8\u05db";
            return x.replaceAll("<>", s);
        }
        return "null";
    }

    public static String getAttacked(String s, String s2) {
        if (Announcer.mode.getValue().equalsIgnoreCase("English")) {
